...
exports.smsg = (hans, m, store) => {
    ...
    logger.debug('Processing raw message:', {
        key: m.key,
        messageTypes: m.message ? Object.keys(m.message) : [],
        fromMe: m.key?.fromMe,
    ...
    if (m.message) {
        ...
        logger.debug('Message type:', { type: m.mtype });
        ...
        try {
            ...
            // Log extracted message body
            logger.debug('Extracted message body:', { 
                body: m.body,
                type: m.mtype
            });
    ...
    logger.debug('Final processed message:', {
        id: m.id,
        from: m.sender,
        chat: m.chat,
        type: m.mtype,
